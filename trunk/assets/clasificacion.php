...
<div class="filtro-equipo"><select id="torneo" onchange="loadJornadasClas()"></select></div>
<div class="filtro-equipo"><select id="jornada" onchange="loadClasificacion()"></select></div>

<div class="clear"></div>
<div id="bd-clasificacion"></div>
